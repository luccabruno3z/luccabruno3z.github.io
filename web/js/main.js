...
import { loadData, loadTierConfig, loadLogoManifest, loadAliases, loadAtlas } from './data.js';
...
async function boot() {
    ...
    await Promise.all([loadTierConfig(), loadLogoManifest(), loadAliases(), loadAtlas()]);
